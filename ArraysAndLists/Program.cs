...
namespace ArraysAndLists
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Even {evenNumber} is an even number");
            }
            ...
            for (var oddNumber = 0; oddNumber < odds.Count; oddNumber++)
            {
                Console.WriteLine($"Isn't it odd how {(odds[oddNumber])} is an odd number?");
            }
        }
    }
}
